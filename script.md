...
Now he can switch back to his code and finish his experiment:

$ git checkout experiment

# change the code 
$ git commit -am "Finishing the experiment"
...
Fry is now done with his code and he can proudly share the results

The good thing about this setup, is that Fry can quickly switch between
the branches and contribute to the 'master' of the project if he needs to.
